...
namespace ZUGFeRD_Test
{
  ...
  public class ZUGFeRD21Tests : TestBase
  {
    ...
    public void TestStoringSepaPreNotification()
    {
      ...
      d.Seller.SpecifiedLegalOrganization.ID = new GlobalID(GlobalID.SchemeID_SIRENE, d.Seller.GlobalID.ID);
      ...
      using (var stream = new MemoryStream())
      {
        ...
        Assert.AreEqual("0088", d.Seller.SpecifiedLegalOrganization.ID.SchemeID);
